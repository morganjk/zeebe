...
import io.zeebe.broker.workflow.processor.deployment.DeploymentCreatingProcessor;
...
public class WorkflowInstanceStreamProcessor implements StreamProcessorLifecycleAware {
  ...
  public TypedStreamProcessor createStreamProcessor(TypedStreamEnvironment environment) {
    ...
    addDeploymentEventStreamProcessors(streamProcessorBuilder);
  ...
  public void addDeploymentEventStreamProcessors(TypedEventStreamProcessorBuilder builder) {
    builder
        .onCommand(
            ValueType.DEPLOYMENT, DeploymentIntent.CREATING, new DeploymentCreatingProcessor())
        .onEvent(
            ValueType.DEPLOYMENT,
            DeploymentIntent.CREATED,
            new DeploymentCreatedProcessor(workflowCache));
  }
