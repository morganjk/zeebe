...
public class DeploymentTransformer {
  ...
  private final DeploymentsStateController stateController;

  // internal changes during processing
  private RejectionType rejectionType;
  private String rejectionReason;

  public DeploymentTransformer(DeploymentsStateController stateController) {
  ...
  private void transformWorkflowResource(
    ...
    for (Process workflow : processes) {
      if (workflow.isExecutable()) {
        ...
        final long key = stateController.getNextWorkflowKey();
        final int version = stateController.getNextVersion(bpmnProcessId);
